...
void displayMoviesFromFile(string dataPath)
{
    ...
    while (!sr.EndOfStream)
    {
        ...
        {//Assume first that quotation marks are used to lower
            int indexOfFirstDelimeter1 = line.IndexOf(DELIMETER_1) + 1;
            int indexOfLastDelimeter1 = line.Substring(indexOfFirstDelimeter1).LastIndexOf(DELIMETER_1);
        ...
        // string[] secondary = line.Substring(line.IndexOf(DELIMETER_1) + 1).Split(DELIMETER_2);
        lineNumber++;
    }
    sr.Close();
